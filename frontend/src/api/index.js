...
// 获取每日统计
export const getDailyStats = async (start, end) => {
  const params = {};
...
// 获取汇总统计
export const getSummaryStats = async (start, end) => {
  const params = {};
  if (start) params.start = start;
  if (end) params.end = end;
...
// 获取门店统计
export const getStoreStats = async (start, end) => {
  const params = {};
  if (start) params.start = start;
  if (end) params.end = end;
...
// 获取 Top10 商品
export const getTop10Products = async (start, end) => {
  const params = {};
  if (start) params.start = start;
  if (end) params.end = end;
...
// 获取支付方式统计
export const getPaymentStats = async (start, end) => {
  const params = {};
  if (start) params.start = start;
  if (end) params.end = end;
